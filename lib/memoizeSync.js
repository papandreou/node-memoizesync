    ...
    return function memoizeSync(lambda, options) {
        ...
        if (options.cache) {
            ...
            for (var propertyName in options) {
                if (Object.prototype.hasOwnProperty.call(options, propertyName) && propertyName !== 'argumentsStringifier' && propertyName !== 'cacheKeyPrefix') {
        ...
        function memoizer() { // ...
            ...
            if (!exceptionAndReturnValue) {
                var returnValue,
                    exception = null;
                try {
                    returnValue = lambda.apply(that, args);
                } catch (e) {
                    exception = e;
                }
